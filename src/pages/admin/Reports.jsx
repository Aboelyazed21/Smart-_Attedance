...
import { useLanguage } from "../../utils/i18n";
  ...
  switch (type) {
    case "lab":
      return tr("reports.typeLaboratory");
    case "hall":
      return tr("reports.typeHall");
    case "classroom":
      return tr("reports.typeClassroom");
    default:
      return type || tr("reports.typeUnknown");
  }
}
  ...
  const { t } = useLanguage();
    ...
    const loadRooms = async () => {
      try {
        ...
        setError(
          err?.message ||
          t("reports.failed_to_load_rooms")
        );
    ...
    const handleSubmit =
      async (event) => {
        ...
        if (!building) {
          setError(
            t("reports.please_enter_a_building_name")
          );
          return;
        }
        ...
        if (!roomName) {
          setError(
            t("reports.please_enter_a_room_name")
          );
          return;
        }
        ...
        if (
          ...
          setError(
            t("reports.capacity_must_be_greater_than_0")
          );
          return;
        }
    ...
    const handleDelete =
      async (room) => {
        const confirmed =
          window.confirm(
            t("reports.confirmDelete").replace("{name}", room.room_name)
          );
        ...
        try {
          ...
          setError(
            err?.message ||
            t("reports.failed_to_delete_room")
          );
          ...
          <header className="rooms-header">
            ...
            <div className="rooms-header-row">
              ...
              <div>
                ...
                <p>
                  {t("reports.manage_classrooms_labs_and_halls_across")}
                </p>
          ...
          <section className="rooms-content">
            ...
            {error && !showModal && (
              <div className="rooms-error">
                ...
                <strong>
                  {t("reports.something_went_wrong")}
                </strong>
            ...
            <div className="rooms-stats-grid">
              ...
              <div className="room-stat-card">
                ...
                <div>
                  ...
                  <span>
                    {t("reports.total_buildings")}
                  </span>
  
                  <small>
                    {t("reports.campus_buildings")}
                  </small>
              ...
              <div className="room-stat-card">
                ...
                <div>
                  ...
                  <span>
                    {t("reports.total_rooms")}
                  </span>
  
                  <small>
                    {t("reports.classrooms_labs")}
                  </small>
              ...
              <div className="room-stat-card">
                ...
                <div>
                  ...
                  <span>
                    {t("reports.total_capacity")}
                  </span>
  
                  <small>
                    {t("reports.across_all_rooms")}
                  </small>
              ...
              <div className="room-stat-card">
                ...
                <div>
                  ...
                  <span>
                    {t("reports.laboratories")}
                  </span>
  
                  <small>
                    {t("reports.specialized_labs")}
                  </small>
            ...
            <section className="rooms-management-card">
              ...
              <div className="rooms-management-header">
                ...
                <div>
                  ...
                  <h2>
                    {t("reports.rooms_management")}
                  </h2>
  
                  <p>
                    {t("reports.view_add_edit_and_manage_campus_rooms")}
                  </p>
              ...
              <div className="rooms-filter-bar">
                ...
                <div className="rooms-search-box">
                  ...
                  <input
                    ...
                    placeholder={t("reports.search_by_room_name_building_or_type")}
                  />
                ...
                >
                  ...
                  <option value="set">
                    {t("reports.location_set")}
                  </option>
  
                  <option value="not-set">
                    {t("reports.location_not_set")}
                  </option>
              ...
              <div className="rooms-table-container">
                ...
                {loading ? (
                  ...
                  <div className="rooms-loading">
                    ...
                    <strong>
                      {t("reports.loading_rooms")}
                    </strong>
  
                    <span>
                      {t("reports.fetching_campus_room_data")}
                    </span>
                  ...
                  <div className="rooms-empty">
                    ...
                    <p>
                      ...
                      typeFilter !==
                        "all"
                        ? t("reports.try_changing_your_filters")
                        : t("reports.create_your_first_campus_room")}
                    </p>
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th className="check-column">
                          <input
                            type="checkbox"
                            aria-label={t("reports.select_all_rooms")}
                          />
                        </th>
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="check-column">
                                <input
                                  type="checkbox"
                                  aria-label={t("reports.selectRoom").replace("{name}", room.room_name)}
                                />
                              </td>
              ...
              <section className="rooms-info-card">
                ...
                <div className="rooms-card-title">
                  ...
                  <div>
                    ...
                    <h3>
                      {t("reports.room_type_distribution")}
                    </h3>
  
                    <p>
                      {t("reports.overview_of_room_types")}
                    </p>
              ...
              <section className="rooms-info-card">
                ...
                <div className="rooms-card-title">
                  ...
                  <div>
                    ...
                    <h3>
                      {t("reports.capacity_overview")}
                    </h3>
  
                    <p>
                      {t("reports.room_capacity_statistics")}
                    </p>
              ...
              <section className="rooms-info-card recent-card">
                ...
                <div className="rooms-card-title">
                  ...
                  <div>
                    ...
                    <h3>
                      {t("reports.recent_rooms")}
                    </h3>
  
                    <p>
                      {t("reports.recently_added_rooms")}
                    </p>
              ...
              <div className="rooms-modal-header">
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      {editingRoom
                        ? t("reports.update_room_information")
                        : t("reports.create_a_new_campus_room")}
                    </p>
              ...
              >
                ...
                <div className="rooms-form-group">
                  ...
                  <input
                    ...
                    placeholder={t("reports.example_building_a")}
                    required
                  />
                ...
                <div className="rooms-form-group">
                  ...
                  <input
                    ...
                    placeholder={t("reports.example_lab_1")}
                    required
                  />
                ...
                <div className="rooms-location-section">
                  ...
                  <div className="rooms-location-title">
                    ...
                    <div>
                      ...
                      <h3>
                        {t("reports.location_2")}
                      </h3>
  
                      <span>
                        {t("reports.optional_gps_coordinates")}
                      </span>
                    ...
                    {saving
                      ...
                      : (
                        <>
                          ...
                          {editingRoom
                            ? t("reports.update_room")
                            : t("reports.create_room")}
                        </>
                      )}
